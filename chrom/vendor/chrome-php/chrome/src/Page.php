...
class Page
{
     ...
     * @return $this
     */
    public function waitForReload($eventName = self::LOAD, $timeout = 400000, $loaderId = null)
    {
        $this->assertNotClosed();
     ...
     * @return Page
     */
    public function waitUntilContainsElement($selectors, int $timeout = 400000): self
    {
        $this->assertNotClosed();
     ...
     * @throws CommunicationException
     */
    public function setHtml(string $html, int $timeout = 40000, string $eventName = self::LOAD): void
    {
